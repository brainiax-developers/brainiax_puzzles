...
class SlitherlinkSolver extends PuzzleSolver<SlitherlinkBoard> {
  ...
  SolverResult<SlitherlinkBoard> solve(
    ...
    final SlitherlinkGrid grid = SlitherlinkGrid.fromBoard(board);
    final _SlitherlinkSolverState initialState =
        _SlitherlinkSolverState.fromGrid(grid, metrics);
    if (!initialState.initializeFromGrid(grid)) {
      stopwatch.stop();
...
class _SlitherlinkSolverState {
  ...
  factory _SlitherlinkSolverState.fromGrid(
    SlitherlinkGrid grid,
  ...
  bool initializeFromGrid(SlitherlinkGrid grid) {
    totalOnEdges = 0;
    ...
    for (int edge = 0; edge < grid.edges.length; edge++) {
      final int value = grid.edges[edge];
